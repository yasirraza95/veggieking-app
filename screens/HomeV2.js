import { Dimensions, View, Text, SafeAreaView, StyleSheet, Image, TextInput, TouchableOpacity, FlatList,
    ...
    <View>
      ...
      <FlatList horizontal={true} data={category} keyExtractor={item=> item.id}
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center' }}>
          <TouchableOpacity key={index} onPress={()=> navigate.navigate("CategoryProducts", { catId: item.id, catName:
            item.name })}
            >
            <View style={{
                    height: 90,
