...
<SafeAreaView style={styles.area}>
    ...
    <View style={styles.center}>
        <Image source={illustrations.mapLocation} resizeMode='contain' style={styles.locationImage} />
        ...
        <TouchableOpacity style={styles.addButton}>
            <View style={styles.buttonContent} color={COLORS.white}>
                <Text style={styles.addButtonText} onPress={()=> navigation.navigate('LocationSearch')}
        ...
        <Text style={styles.bottomText}>VEGGIE KING WILL ACCESS YOUR LOCATION ONLY WHILE USING THE APP</Text>
    </View>
</SafeAreaView>
)
}
